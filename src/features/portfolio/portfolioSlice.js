...
const initialState = {
  ...
  experience: [
    {
      company: "EY Global Delivery Services India LLP      ",
      role: "Technical Lead",
  ...
  achievements: [
    {
      ...
      description:
        "Got this award for solving maximum bugs, played a crucial role in the migration process, handling the transition from an older product to the latest version during the release of NewgenOne Migration (Jan 2024).",
    },
    {
      title: "Star Performer Award",
      description:
        "Got this award for obtaining the highest score among all trainees (Aug 2021).",
    },
    {
      title: "Competitive Programming",
      description:
        "Solved more than 200+ problems on LeetCode, HackerRank, Spoj, and Gfg. Completed React Developer Course and earned the certificate.",
    },
    {
      title: "Content Writer",
      description:
        "Worked as a content writer for an NGO named Swapna Foundation.",
    },
    {
      title: "Sports",
